...
df = pd.read_csv('NumpyPractice/Startups in 2021 end.csv',delimiter=";", parse_dates=[14],  date_format={'date_added': '%m-%d-%Y'} , index_col='property_id')
...
#kind='hist'  
g=sns.displot(data=dffilter, x="Industry" , y="Valuation ($B)" , hue="Select Investors",  kind='hist'  )
g.figure.suptitle("sns.displot(data=dffilter, x=Investors , y=Valuation ($B) , hue=Select Investors,  kind='hist'  )"  )
...
#kind='kde'
g=sns.displot(data=dffilter, x="Industry" , y="Valuation ($B)" , kind='kde'  )
g.figure.suptitle("sns.displot(data=dffilter, x=Industry , y=date_added , kind='kde'  )"  )
...
#kind='kde'
g=sns.kdeplot(data=dffilter, x="Industry")
...
g = sns.histplot(data=dffilter, x='Industry', y='Valuation ($B)', hue='Select Investors', multiple="stack")
g.figure.suptitle("sns.histplot(data=dffilter, x='Industry', y='Valuation ($B)', hue='Select investors', multiple=stack)"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g = sns.scatterplot(x='Industry', y='Valuation ($B)', data=dffilter)
g.figure.suptitle("sns.scatterplot(x='Investors', y='Valuation ($B)', data=dffilter)"  )
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
The relationship between x and y can be shown for different subsets of the data using the hue, size, and style parameters. These parameters control what visual semantics are used to identify the different subsets. It is possible to show up to three dimensions independently by using all three semantic types, but this style of plot can be hard to interpret and is often ineffective. Using redundant semantics (i.e. both hue and style for the same variable) can be helpful for making graphics more accessible."""
g=sns.lineplot(data=dffilter, x="Investors" , y="Valuation ($B)"  )
g.figure.suptitle("sns.lineplot(data=dffilter, x=Investors , y=Valuation ($B))"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g=sns.barplot(data=dffilter, x="Investors", y="Valuation ($B)", legend=False)
g.figure.suptitle("sns.barplot(data=dffilter, x=Investors, y=Valuation ($B), legend=False)"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g=sns.catplot(data=dffilter, x="Investors", y="Valuation ($B)")
g.figure.suptitle("sns.catplot(data=df, x=Investors, y=Valuation ($B))"  )
# Display the plot
g.figure.show() 
read = input("Wait for me....")
#g.figure.clear()
...
#.pivot(index="Model", columns="Investors", values="Valuation ($B)")
glue = dffilter.pivot(columns="Investors", values="Valuation ($B)")

g=sns.heatmap(glue)
g.figure.suptitle("sns.heatmap(glue)  - glue = dffilter.pivot(columns=Investors, values=Valuation ($B))"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
