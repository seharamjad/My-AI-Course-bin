...
# FastFoodRestaurant data - based examples
# Load data from a CSV file
df = pd.read_csv('NumpyPractice/FastFoodRestaurants.csv',delimiter=",", index_col='keys')
...
#kind='hist'  
g=sns.displot(data=dffilter, x="name" , y="longitude" , hue="latitude",  kind='hist'  )
g.figure.suptitle("sns.displot(data=dffilter, x=name , y=longitude , hue=latitude,  kind='hist'  )"  )
...
g = sns.histplot(data=dffilter, x='name', y='longitude', hue='latitude', multiple="stack")
g.figure.suptitle("sns.histplot(data=dffilter, x='name', y='longitude', hue='latitude', multiple=stack)"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g = sns.scatterplot(x='name', y='longitude', data=dffilter)
g.figure.suptitle("sns.scatterplot(x='name', y='longitude', data=dffilter)"  )
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g.figure.suptitle("sns.lineplot(data=dffilter, x=name , y=longitude  )"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
...
g=sns.barplot(data=dffilter, x="name", y="longitude", legend=False)
g.figure.suptitle("sns.barplot(data=dffilter, x=name, y=longitude, legend=False)"  )
# Display the plot
g.figure.show()
read = input("Wait for me....")
#g.figure.clear()
