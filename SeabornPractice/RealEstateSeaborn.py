...
df = pd.read_csv('NumpyPractice/RealEstate-USA.csv',delimiter=",", parse_dates=[11],  date_format={'date_added': '%m-%d-%Y'} , index_col='brokered_by')
...
g = sns.histplot(data=dffilter, x='house_size', y='price', hue='acre_lot', multiple="stack")
